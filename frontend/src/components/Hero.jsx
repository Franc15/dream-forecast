    ...
    return (
        ...
        <Parallax pages={5} ref={ref} style={{ backgroundColor: '#02040F'}}>
            ...
            <h1 className="text-5xl mx-auto w-[50%] mt-[20%] text-[#F4F4F6] font-bold tracking-wider font-poppins">
                ...
                <button onClick={() => setShowModal(true)} type='button' className='font-poppins rounded-xl w-[20%] mt-16 ml-[50%] transform -translate-x-1/2 h-4 bg-yellow-500 p-8 text-[#F4F4F6] text-2xl flex justify-center items-center'> 
                Try Onyrix</button>
